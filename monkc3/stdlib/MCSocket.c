...
fun(receive, void)) as(MCSocket)
    //recv(int, void *, size_t, int)
}

fun(receiveFrom, void)) as(MCSocket)
    //recvfrom(int, void *, size_t, int, struct sockaddr *restrict, socklen_t *restrict)
}

fun(receiveMsg, void)) as(MCSocket)
    //recvmsg(int, struct msghdr *, int)
}

fun(sendInfo, void)) as(MCSocket)
    //send(int, const void *, size_t, int)
}

fun(sendTo, void)) as(MCSocket)
    //sendto(int, const void *, size_t, int, const struct sockaddr *, socklen_t)
}

fun(sendMsg, void)) as(MCSocket)
