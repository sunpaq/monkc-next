...
static inline MCTriangle MCTriangleMake(MCVector3 a, MCVector3 b, MCVector3 c)
{
    return (MCTriangle){a, b, c};
}

static inline MCTriangle MCTriangleMakeByArray(MCVector3 tri[3])
{
    return (MCTriangle){tri[0], tri[1], tri[2]};
}

static inline MCTriangle4 MCTriangle4Make(MCVector4 a, MCVector4 b, MCVector4 c)
{
 ...
 */
static inline double MCTriangleAreaByEdgeLength(double a, double b, double c)
{
    double p = (a+b+c)/2;
    return sqrt(p*(p-a)*(p-b)*(p-c));
}

static inline double MCTriangleAreaByVertexes(MCVector3 A, MCVector3 B, MCVector3 C)
{
...
static inline double MCTriangleArea(MCTriangle tri)
{
    return MCTriangleAreaByVertexes(tri.a, tri.b, tri.c);
}

static inline bool MCTriangleHaveVertex(MCTriangle tri, MCVector3 P)
{
...
static inline bool MCVertexOnLine(MCVector3 A, MCVector3 B, MCVector3 P)
{
...
static inline bool MCVertexesInSameSideOf(MCVector3 A, MCVector3 B, MCVector3 p1, MCVector3 p2)
{
    MCVector3 AB = MCVector3Sub(B, A);
...
static inline bool MCTriangleContainsVertex(MCTriangle tri, MCVector3 P)
{
    MCVector3 A = tri.a;
    MCVector3 B = tri.b;
    MCVector3 C = tri.c;
...
static inline bool MCTriangle4ContainsVertex4(MCTriangle4 tri4, MCVector4 P4)
{
...
static inline MCVector3 MCTriangleCCWFaceUp(MCTriangle tri)
{
    MCVector3 A = tri.a;
    MCVector3 B = tri.b;
    MCVector3 C = tri.c;
